...
CMovingCam2DOneself::CMovingCam2DOneself(VTCalibration mode, QObject *parent)
	: CPointsManage(mode, parent)
{
}

CMovingCam2DOneself::~CMovingCam2DOneself()
{
}

bool CMovingCam2DOneself::fixdFirstFrame()
{
	return true;
}

void CMovingCam2DOneself::clearImagePoints(int index)
{

}

bool CMovingCam2DOneself::imagePointsReady(int index)
{
...
bool CMovingCam2DOneself::actualPointsReady()
{
...
void CMovingCam2DOneself::addPoints(int index, QPoint point)
{
...
void CMovingCam2DOneself::calcPointP0()
{
...
void CMovingCam2DOneself::calcVelocity()
{
	if (!actualPointsReady())
		return;
...
void CMovingCam2DOneself::notifyVelocity()
{
	emit sigNotifyVelocity();
}

void CMovingCam2DOneself::initForecast() {
	cv::Mat firstFrame;
	if (!fixdFirstFrame())
		return;
	m_keyTrack.release();
...
void CMovingCam2DOneself::doForecast(int index)
{
	...
	g_proInfo.frameInfos[index].imagePoints[3] = points[5];
}